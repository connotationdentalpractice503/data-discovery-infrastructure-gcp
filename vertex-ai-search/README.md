...
terraform apply \
  ...
  -var="jsonl_bucket_name=YOUR_PROJECT_ID-data-discovery-jsonl"
```
...
gcloud alpha discovery-engine data-stores import documents \
  ...
  --gcs-uri=gs://YOUR_PROJECT_ID-data-discovery-jsonl/*.jsonl
```
...
client.import_documents_from_gcs(
    gcs_uri="gs://YOUR_PROJECT_ID-data-discovery-jsonl/*.jsonl"
)
```
