...
gcloud dataplex datascans run \
  projects/YOUR_PROJECT_ID/locations/us-central1/dataScans/profile-your_dataset-your_table
```
...
profiler = DataplexProfiler(project_id="YOUR_PROJECT_ID", location="us-central1")

# Run a scan
scan_name = "projects/YOUR_PROJECT_ID/locations/us-central1/dataScans/profile-your_dataset-your_table"
