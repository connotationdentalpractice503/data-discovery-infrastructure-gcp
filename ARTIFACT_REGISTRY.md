...
Example output:
```
us-central1-docker.pkg.dev/YOUR_PROJECT_ID/data-discovery
```
...
docker tag data-discovery-mcp:latest \
  us-central1-docker.pkg.dev/YOUR_PROJECT_ID/data-discovery/mcp:latest

# 4. Push to Artifact Registry
docker push us-central1-docker.pkg.dev/YOUR_PROJECT_ID/data-discovery/mcp:latest
```
...
spec:
  containers:
  - name: mcp
    image: us-central1-docker.pkg.dev/YOUR_PROJECT_ID/data-discovery/mcp:latest
```
...
# Pull image
docker pull us-central1-docker.pkg.dev/YOUR_PROJECT_ID/data-discovery/mcp:latest
```
...
gcloud artifacts docker tags list \
  us-central1-docker.pkg.dev/YOUR_PROJECT_ID/data-discovery/mcp
```
...
gcloud artifacts docker images delete \
  us-central1-docker.pkg.dev/YOUR_PROJECT_ID/data-discovery/mcp:v1.0.0 \
  --delete-tags
```
